...
# create the event handler to open a file dialog
def evOpenFile():
...
bOpen = tk.Button(fButtons, text="Open File", command=evOpenFile)
bOpen.pack(side="left", padx=5, pady=2)
